...
const locations: Location[] = [
  ...
  { id: '11', name: 'LCS of Nocatee', city: 'Nocatee', state: 'FL', zipCode: '32081', phone: '904.917.2525', lat: 32.2216, lng: -81.3696 },
    ...
    <>
      <div className="min-h-screen bg-gray-50">
        <HeroSection
          ...
          Herodescription="Find the nearest Lawn Care Services to your location."
