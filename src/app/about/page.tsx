...
const About = () => {
    return (
        <>
            ...
            <section className="py-16 bg-white">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="border-2 border-green-100 rounded-lg p-6 text-center hover:shadow-lg transition-all duration-300 h-full flex flex-col">
            ...
            <section className="w-full py-16 sm:py-24 bg-white ">
                <div className="w-full sm:mx-auto px-6">
                        ...
                        <div className="flex flex-col sm:flex-row w-full space-y-6 justify-center gap-2">
                            <h2 className="w-full px-6 sm:w-1/2 text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-4 text-center sm:text-left mx-0 sm:ml-20">
            ...
            {/* Stats section */}
            <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-2xl p-8 sm:p-12 min-h-[40vh]">
            ...
            <section className="relative py-20 md:py-28 overflow-hidden">
                ...
                <div className="absolute inset-0 -z-10">
                    <div className="relative w-full h-full">
                        <Image
                            src="https://res.cloudinary.com/dfnjpfucl/image/upload/v1754991630/gallery-bg-image-2_bwqtp2.jpg"
                ...
                <div className="flex justify-start items-center px-10 sm:px-20 h-full max-w-2xl">
                    <div className="text-start">
                        ...
                        <p className="text-white text-md mb-8 max-w-3xl text-center sm:text-left">
