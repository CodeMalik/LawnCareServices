...
const metadata: Metadata = {
    ...
    description:
        'Learn about our passion for creating beautiful outdoor spaces. With years of experience, we transform landscapes into stunning, sustainable environments.',
    keywords: [
        'about us',
        'landscaping company',
        'our story',
    ...
    openGraph: {
        ...
        description:
            'Discover our commitment to excellence in landscaping and outdoor design services.',
        type: 'website',
        locale: 'en_US',
    },
};
...
const About = () => {
    // Define features array with explicit typing
    const features: Feature[] = [
        {
            ...
            description:
                'We show up on time, get the job done efficiently, and leave your lawn looking better than ever, no delays, no excuses.',
        },
        {
            icon: (
                <path
            ...
            description:
                'Founded by Jamie Cervantes, our team brings decades of hands-on landscaping knowledge to every yard we touch.',
        },
        {
            icon: (
                <>
            ...
            description:
                'From Dallas, TX to Denton, we\'ve earned a reputation for honest work, fair pricing, and results that speak for themselves.',
        },
        {
            icon: (
                <path
            ...
            description:
                'We don\'t just work outdoors, we respect it. Every service we provide is built on care for the land and the life it holds.',
        },
    ];
                    ...
                    <ScaleIn>
                        <div className="w-full sm:max-w-7xl px-6 py-16 text-center">
                            ...
                            <h1 className="text-xl sm:text-4xl md:text-6xl 2xl:text-7xl font-bold text-white leading-tight mb-6 px-6 sm:px-50 2xl:px-20">
                                Meet the Lawn Care Services
                            </h1>
                            {/* Subtitle */}
                            <p className="text-white text-sm sm:text-md md:text-lg 2xl:text-xl leading-relaxed w-full text-center px-6 sm:px-50">
                                Lawn Care Services blends expert landscaping,
                                irrigation repair, and lawn care with a commitment
                                to quality, reliability, and personal service.
                                This isn’t just our work, it’s our craft, and we
                                take pride in every project we touch.
                            </p>
                        </div>
                    </ScaleIn>
                </div>
                                ...
                                <SlideInBottom yOffset={100} duration={0.4}>
                                    <div className="border-1 border-green-100 rounded-lg p-6 text-center hover:shadow-lg transition-all duration-300 h-full flex flex-col">
                                        ...
                                        <p className="text-sm text-gray-600 leading-relaxed flex-grow">
                                            To provide dependable, expert
                                            landscaping services that help
                                            homeowners enjoy healthy, beautiful
                            ...
                            <StaggeredItem>
                                <SlideInBottom yOffset={100} duration={0.4}>
                                    <div className="border-1 border-green-100 rounded-lg p-6 text-center hover:shadow-lg transition-all duration-300 h-full flex flex-col">
                                        ...
                                        <p className="text-sm text-gray-600 leading-relaxed flex-grow">
                                            To be the most trusted landscaping
                                            company in North Texas, known for
                                            honest service, lasting results, and
                            ...
                            <StaggeredItem>
                                <SlideInBottom yOffset={100} duration={0.4}>
                                    <div className="border-1 border-green-100 rounded-lg p-6 text-center hover:shadow-lg transition-all duration-300 h-full flex flex-col">
                                        ...
                                        <p className="text-sm text-gray-600 leading-relaxed flex-grow">
                                            At Lawn Care Services, we believe in
                                            honest work, lasting quality, and
                                            putting our customers first. Every
                                            service is guided by respect for
                                            nature.
                                        </p>
                                    </div>
                                </SlideInBottom>
                ...
                <div className="w-full sm:max-w-[1200px] md:max-w-[1200px] lg:max-w-[1200px] xl:max-w-[1200px] 2xl:max-w-[1300px] mx-auto px-6 2xl:px-20">
                    <div className="flex flex-col sm:flex-row w-full space-y-6 justify-center gap-2">
                        ...
                        <p className="w-full sm:w-1/2 2xl:w-[55%] 2xl:pr-0 text-gray-600 text-sm sm:text-md sm:px-20 2xl:px-0 2xl:pl-10 text-center  2xl:text-lg">
                            For decades, Lawn Care Services has been Dallas's
                            go-to for reliable sprinkler repair, precise
                            irrigation, and lawn care that actually lasts. We
                            don't just mow, we protect, restore, and elevate
                            your outdoor space. From lush green lawns to
                            flawless sprinkler systems, we deliver fast, honest
                            service and results that speak for themselves.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="text-center mb-12 md:mb-16">
                        ...
                        <p className=" text-md sm:text-lg text-gray-600 max-w-3xl mx-auto px-4">
                            Serving <strong className="font-semibold">Dallas, TX,</strong>{' '}
                            for over 25 years with care, consistency, and
                    ...
                    <div className="text-center">
                        <ScaleIn>
                            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 leading-12 text-center">
                                Let’s Shape Nature into Your Dream Space
                            </h2>
                            <svg
                            ...
                            <p className="text-white text-md mb-8 max-w-3xl text-center">
                                Whether it’s lush lawn care, expert sprinkler
                                repair, or full-scale landscaping, Lawn Care
                                Services is here to help your yard thrive.
                            </p>
