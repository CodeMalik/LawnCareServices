...
import { serviceContent } from '../location-services-data';
...
export async function generateStaticParams() {
    // Return empty array to prevent generating invalid location-service URLs
    // This will make these routes dynamically generated only when accessed
    return [];
}
