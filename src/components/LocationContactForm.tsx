              ...
              <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    required
                    className="block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-200 p-2.5 text-sm transition-all duration-200"
                  />
                </div>
                <div className="space-y-1">
                ...
                {showService && (
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-200 p-2.5 text-sm transition-all duration-200 appearance-none bg-white"
                    >  
                ...
                <div className="flex items-start space-x-3 pt-2">
                  ...
                  <label htmlFor="agreed" className="text-sm text-gray-700">
                    I agree to the <a href="/terms" className="text-green-600 hover:underline font-medium">Terms and Conditions</a> and <a href="/privacy" className="text-green-600 hover:underline font-medium">Privacy Policy</a>.
                  </label>
                </div>
                <button
                  type="submit"
                  className={`w-full py-3 px-6 rounded-lg font-medium text-white transition-all duration-300 transform ${
                    !agreed || (showPrice && formData.acceptedPrice === undefined)
                      ? 'bg-gray-400 cursor-not-allowed'
                      : 'bg-green-600 hover:bg-green-700 hover:scale-[1.02] active:scale-[0.98] shadow-md hover:shadow-lg'
