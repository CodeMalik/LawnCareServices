...
import { faqItems } from '@/lib/data'; // ✅ We'll define the type locally
import Image from 'next/image';
import { FadeIn } from './animations/Animate';

// ✅ Define FAQ item type locally (since it's not exported from '@/lib/data')
...
// ✅ FAQ Item Component — fully typed
                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-20">
                    ...
                    <FadeIn>
                        <div className="max-w-2xl mx-auto lg:max-w-none">
                            ...
                            <div className="space-y-6" role="tablist" aria-label="Frequently Asked Questions">
