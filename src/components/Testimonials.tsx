...
const TestimonialCard = ({ testimonial }: TestimonialCardProps): React.ReactNode => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="rounded-xl text-center mb-10">
            ...
            <p className="text-gray-700 text-sm max-w-2xl mx-auto">
              Based on <strong>{testimonials.length} reviews</strong>
            </p>
            <div className="mb-8">
          ...
          <div className="relative flex justify-center items-center mx-auto">
            <button
              type="button"
              onClick={prevSlide}
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-50 transition-colors md:block hidden"
            ...
            <button
              type="button"
              onClick={nextSlide}
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-50 transition-colors md:block hidden"
